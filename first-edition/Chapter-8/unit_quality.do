...
capture log close
log using c:\Empirical_Exercise\Chapter_8\unit_quality.log,replace
...
save c:\Empirical_Exercise\Chapter_8\quality_c,replace
...
save c:\Empirical_Exercise\Chapter_8\quality_t,replace
