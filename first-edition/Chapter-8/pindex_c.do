clear
capture log close
log using c:\Empirical_Exercise\Chapter_8\pindex_c.log,replace
...
ren quan quan_80
sort model
save c:\Empirical_Exercise\Chapter_8\car_80,replace
restore

sort model
merge model using c:\Empirical_Exercise\Chapter_8\car_80
keep if _merge==3
drop _merge
