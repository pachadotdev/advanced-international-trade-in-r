clear
capture log close
log using c:\Empirical_Exercise\Chapter_8\qindex_t.log,replace

use c:\Empirical_Exercise\Chapter_8\quality_t,clear
...
ren quan quan_80
sort model
save c:\Empirical_Exercise\Chapter_8\quality_80_t,replace
restore

sort model
merge model using c:\Empirical_Exercise\Chapter_8\quality_80_t
keep if _merge==3
drop _merge
