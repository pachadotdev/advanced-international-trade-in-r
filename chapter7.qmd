...
if (!file.exists(fout)) {
  feenstra_93 <- list(
    cars = fread(paste0(dout, "/cars.csv")),
    cycon = fread(paste0(dout, "/cycon.csv"))[time > 16 & time < 45],
    cypool = fread(paste0(dout, "/cypool.csv")),
    cyship = fread(paste0(dout, "/cyship.csv"))[time > 16],
    trucks = fread(paste0(dout, "/trucks.csv"))[time > 12]
  )
...
stat <- estimate / se
data.table(estimate = estimate, std.error = se, statistic = stat, p.value = p_value(stat, mod1_summ))
...
stat <- estimate / se
data.table(estimate = estimate, std.error = se, statistic = stat, p.value = p_value(stat, summary(mod2)))
...
stat <- estimate / se
data.table(estimate = estimate, std.error = se, statistic = stat, p.value = p_value(stat, summary(mod3)))
...
stat <- estimate / se
data.table(estimate = estimate, std.error = se, statistic = stat, p.value = p_value(stat, summary(mod4)))
...
stat <- estimate / se
data.table(estimate = estimate, std.error = se, statistic = stat, p.value = p_value(stat, summary(mod5)))
...
stat <- estimate / se
data.table(estimate = estimate, std.error = se, statistic = stat, p.value = p_value(stat, summary(mod1h)))
...
stat <- estimate / se
data.table(estimate = estimate, std.error = se, statistic = stat, p.value = p_value(stat, summary(mod2h)))
...
stat <- estimate / se
data.table(estimate = estimate, std.error = se, statistic = stat, p.value = p_value(stat, summary(mod3h)))
...
stat <- estimate / se
data.table(estimate = estimate, std.error = se, statistic = stat, p.value = p_value(stat, summary(mod4h)))
...
stat <- estimate / se
data.table(estimate = estimate, std.error = se, statistic = stat, p.value = p_value(stat, summary(mod5h)))
```
